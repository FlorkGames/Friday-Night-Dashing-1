function onCreate()
	...
	addLuaSprite('GDback', false);
      ...
      scaleObject('REDbackgdfnf', 2, 2);
      scaleObject('backgdfnf', 2, 2);
      scaleObject('back', 2, 2);
      scaleObject('robot', 2, 2);
      scaleObject('grass', 2, 2);
      scaleObject('publicgeo', 2, 2);
      scaleObject('scenario', 2, 2);
      scaleObject('GDback', 2, 2);
      scaleObject('dark', 2, 2);
      scaleObject('moredark', 2, 2);
